...
class Migration {
    ...
    public function execute($dropTable = false) {
        ...
        $modelDir = "PHP/Application/Model";
    ...
    protected function createTable($tableName, $columns) {
        ...
        $columnDefinition = join(", ", $columnQueries);

        $createTableQuery = "CREATE TABLE $tableName ($columnDefinition);";
    ...
    protected function updateTable($tableName, array $columns, array $dbColumns) {
        ...
        foreach ($updatedColumns as $column) {
            /** @var Column column */
            $alterStatements[] = "MODIFY " . $column->getSQL();
        }
